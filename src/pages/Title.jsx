...
function Title() {
    return (
        ...
        <img style={{width: 133, height: 142, left: -8, top: 49, position: 'absolute', opacity: 0.70}} src="/himo.png" />
        <img style={{width: 274, height: 274, left: 126, top: 410, position: 'absolute', opacity: 0.40}} src="/Torii.png" />
        ...
        {/* <img style={{width: 56.52, height: 56.52, left: 179.24, top: 154.29, position: 'absolute', transform: 'rotate(70deg)', transformOrigin: 'top left', background: 'linear-gradient(0deg, rgba(255, 255, 255, 0.20) 0%, rgba(255, 255, 255, 0.20) 100%)', backgroundBlendMode: 'normal, darken', borderRadius: 9999}} src="/Torii.png"/> */}
        {/* <img style={{width: 100.15, height: 100.15, left: 257.10, top: 191.29, position: 'absolute', transform: 'rotate(70deg)', transformOrigin: 'top left', background: 'linear-gradient(0deg, rgba(255, 255, 255, 0.20) 0%, rgba(255, 255, 255, 0.20) 100%)', backgroundBlendMode: 'normal, darken', borderRadius: 9999}} src="/jamijami.png" /> */}
